                ...
                if(!isContain){
                    ...
                    dbRef.child(cartId).setValue(cart, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                            CustomToast.makeText(getApplicationContext(),"Đã thêm sản phẩm vào giỏ hàng",CustomToast.SHORT,CustomToast.ERROR).show();
        ...
        dbRef.child("Users")
                ...
                .removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        CustomToast.makeText(getApplicationContext(),"Đã xóa sản phẩm",CustomToast.SHORT,CustomToast.SUCCESS).show();
                    }
                });
    }
